...
fetch('data.json')
    ...
    .then( data => {
        ...
        techImage.srcset = `${data.technology[0].images.landscape} 300w , ${data.technology[0].images.landscape} 1440w , ${data.technology[0].images.portrait} 2000w`
        ...
        if(index === 0){
            ...
            fetch('data.json')
                ...
                fetch('data.json')
                    .then( res => res.json())
                    .then( data => {
                        techImage.src = data.technology[1].images.landscape
                        techImage.srcset = `${data.technology[1].images.landscape} 300w , ${data.technology[1].images.landscape} 1440w , ${data.technology[1].images.portrait} 2000w`
                        header6.textContent = 'The terminology ...'
                ...
                fetch('data.json')
                    .then( res => res.json())
                    .then( data => {
                        techImage.src = data.technology[2].images.landscape
                        techImage.srcset = `${data.technology[2].images.landscape} 300w , ${data.technology[2].images.landscape} 1440w , ${data.technology[2].images.portrait} 2000w`
                        header6.textContent = 'The terminology ...'
